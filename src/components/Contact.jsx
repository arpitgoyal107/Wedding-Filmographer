      ...
      <section className="bg-white overflow-hidden">
        ...
        <div className="w-full lg:min-h-[calc(100svh-108px)] grid lg:grid-cols-2">
          ...
          <div className="w-full h-full bg-[#FFDFDF] flex justify-center items-center">
            <div className="max-w-[36rem] w-full mx-auto lg:ml-0 lg:mr-auto px-6">
              <div className="mb-16">
              ...
              <div className="my-6">
                <a
                  ...
                  className="font-bold text-base md:text-xl text-[#D14D72]"
                >
                  +91-76963-31130
                </a>
                <p className="py-1 text-sm md:text-base font-bold text-[#D14D72D7] tracking-wide">
                  Questions? Call Us!
                </p>
              </div>
              ...
              <div className="my-6">
                <p className="font-bold text-base md:text-xl text-[#D14D72]">
        ...
        <div className="w-full lg:min-h-[calc(100svh-108px)] grid lg:grid-cols-2">
          <div className="w-full h-full bg-[#FDF0F0] flex justify-center items-center">
            <div className="max-w-[36rem] w-full mx-auto lg:mr-0 lg:ml-auto px-6">
              <div className="mb-16">
                <h1 className="font-bold text-sm md:text-lg text-[#D14D72D7] mt-6">
                  Contact Us
                </h1>

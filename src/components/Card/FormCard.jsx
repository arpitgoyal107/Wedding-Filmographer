    ...
    <>
      <form className="" onSubmit={handleSubmit}>
        <img
          ...
          alt=""
          className=" h-32 float-right mt-[-68px]"
        />
        ...
        <div className=" grid grid-cols-2 gap-12">
          ...
          <div className="flex flex-col mt-3">
            ...
            />
            <p className="p-2 text-sm text-gray-400">
              This field is required. Please input a valid email address.
            </p>
          </div>
        </div>
        ...
        <button
          type="submit"
          className="md:w-32 bg-white text-[#112330] outline outline-gray-300 outline-2 font-bold py-3 px-6 rounded-sm mt-6 hover:bg-[#112330] hover:text-white transition ease-in-out duration-300"
        >
          Send
        </button>
      </form>
